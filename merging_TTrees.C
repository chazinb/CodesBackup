...
//  TTTo2L2Nu_ext1  Sample
   ...
   TFile *part0 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part0.root", "read");
   TFile *part1 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part1.root", "read");
   TFile *part2 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part2.root", "read");
   TFile *part3 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part3.root", "read");
   TFile *part4 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part4.root", "read");
   TFile *part5 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part5.root", "read");
   TFile *part6 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part6.root", "read");
   TFile *part7 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part7.root", "read");
   TFile *part8 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part8.root", "read");
   TFile *part9 = new TFile("../../minitrees/nominal/Stop/TTTo2L2Nu_ext1__part9.root", "read");
