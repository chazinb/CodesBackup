...
TString FileAddress = "../AnalysisCMS/minitrees/nominal/Stop/";
const int nsample = 7;
TString SampleName [nsample] = {"20_T2tt_mStop-150to1200.root", "04_TTTo2L2Nu.root", "05_ST.root",  "07_ZJets.root", "06_WW.root", "09_TTV.root", "03_VZ.root"};
...
// TTV   = TTWJetsToLNu.root TTZToQQ.root TTZjets.root
