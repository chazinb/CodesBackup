...
void AnalysisCMS::ApplyWeights()
{
  ...
  _event_weigth_TTZ_susy = _event_weight;
  ...
  //----------------------------------------------------------------------------
  float sf_trigger    = effTrigW;  // To be updated for WZ and 3 leptons
...
//      if (GEN_weight_SM) printf("  GEN_weight_SM % .2f\n", GEN_weight_SM); else printf("\n");
  ...
  _event_weigth_TTZ_susy =  _event_weight / (sf_btag*puW);
//  printf(" _event_weight_TTZ_susy % f", _event_weigth_TTZ_susy); 
  // ----------------------------------------------------- 
